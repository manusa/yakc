...
@Data
@ToString
public class ResourceClassParameters implements Model {
  ...
  @Singular(value = "addToFilters", ignoreNullCollections = true)
  ...
  @Singular(value = "addToVendorParameters", ignoreNullCollections = true)
