...
@Data
@ToString
public class ContainerSourceSpecTemplate implements Model {
  ...
  private List<ContainerSourceSpecTemplateManagedFields> managedFields;
  ...
  private List<ContainerSourceSpecTemplateOwnerReferences> ownerReferences;
  ...
  /**
   * Specification of the desired behavior of the pod. More info: Type 'kubectl explain pod.spec'. Also, https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
   */
  @JsonProperty("spec")
  private Object spec;
