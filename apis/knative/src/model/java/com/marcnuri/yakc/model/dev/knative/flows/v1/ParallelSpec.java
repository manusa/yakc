...
@Data
@ToString
public class ParallelSpec implements Model {
  ...
  @Singular(value = "addToBranches", ignoreNullCollections = true)
  private List<Object> branches;

  @JsonProperty("channelTemplate")
  private ParallelSpecChannelTemplate channelTemplate;

  @JsonProperty("reply")
  private ParallelSpecReply reply;
