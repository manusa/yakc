...
package com.marcnuri.yakc.api.sourcesknativedev.v1;

import com.marcnuri.yakc.api.Api;
import com.marcnuri.yakc.api.KubernetesCall;
import com.marcnuri.yakc.api.KubernetesListCall;
import com.marcnuri.yakc.model.dev.knative.sources.v1.ApiServerSource;
import com.marcnuri.yakc.model.dev.knative.sources.v1.ApiServerSourceList;
import com.marcnuri.yakc.model.dev.knative.sources.v1.ContainerSource;
import com.marcnuri.yakc.model.dev.knative.sources.v1.ContainerSourceList;
import com.marcnuri.yakc.model.dev.knative.sources.v1.SinkBinding;
import com.marcnuri.yakc.model.dev.knative.sources.v1.SinkBindingList;
...
public interface SourcesKnativeDevV1Api extends Api {
  /**
   * list objects of kind ApiServerSource
   */
  @HTTP(
    method = "GET",
    path = "/apis/sources.knative.dev/v1/apiserversources"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "GET",
    path = "/apis/sources.knative.dev/v1/containersources"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/apiserversources/{name}",
    hasBody = true
  )
  @Headers({ 
    "Content-Type: application/json",
  ...
  @HTTP(
    method = "GET",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/apiserversources/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/containersources"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/containersources/{name}",
    hasBody = true
  )
  @Headers({ 
    "Content-Type: application/json",
  ...
  @HTTP(
    method = "GET",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/containersources/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/sinkbindings/{name}",
    hasBody = true
  )
  @Headers({ 
    "Content-Type: application/json",
  ...
  @HTTP(
    method = "GET",
    path = "/apis/sources.knative.dev/v1/namespaces/{namespace}/sinkbindings/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "GET",
    path = "/apis/sources.knative.dev/v1/sinkbindings"
  )
  @Headers({ 
    "Accept: */*"
  })
