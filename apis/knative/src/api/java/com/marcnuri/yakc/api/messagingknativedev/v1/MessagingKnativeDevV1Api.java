...
import com.marcnuri.yakc.model.dev.knative.messaging.v1.Subscription;
import com.marcnuri.yakc.model.dev.knative.messaging.v1.SubscriptionList;
...
public interface MessagingKnativeDevV1Api extends Api {
  ...
  @HTTP(
    method = "GET",
    path = "/apis/messaging.knative.dev/v1/namespaces/{namespace}/subscriptions/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "GET",
    path = "/apis/messaging.knative.dev/v1/subscriptions"
  )
  @Headers({ 
    "Accept: */*"
  })
