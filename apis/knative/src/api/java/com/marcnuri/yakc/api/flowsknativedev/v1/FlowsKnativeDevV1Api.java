...
package com.marcnuri.yakc.api.flowsknativedev.v1;

import com.marcnuri.yakc.api.Api;
import com.marcnuri.yakc.api.KubernetesCall;
import com.marcnuri.yakc.api.KubernetesListCall;
import com.marcnuri.yakc.model.dev.knative.flows.v1.Parallel;
import com.marcnuri.yakc.model.dev.knative.flows.v1.ParallelList;
import com.marcnuri.yakc.model.dev.knative.flows.v1.Sequence;
import com.marcnuri.yakc.model.dev.knative.flows.v1.SequenceList;
...
public interface FlowsKnativeDevV1Api extends Api {
  /**
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/flows.knative.dev/v1/namespaces/{namespace}/parallels"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/flows.knative.dev/v1/namespaces/{namespace}/parallels/{name}",
    hasBody = true
  )
  @Headers({ 
    "Content-Type: application/json",
  ...
  @HTTP(
    method = "GET",
    path = "/apis/flows.knative.dev/v1/namespaces/{namespace}/parallels/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/flows.knative.dev/v1/namespaces/{namespace}/sequences"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/flows.knative.dev/v1/namespaces/{namespace}/sequences/{name}",
    hasBody = true
  )
  @Headers({ 
    "Content-Type: application/json",
  ...
  @HTTP(
    method = "GET",
    path = "/apis/flows.knative.dev/v1/namespaces/{namespace}/sequences/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "GET",
    path = "/apis/flows.knative.dev/v1/parallels"
  )
  @Headers({ 
    "Accept: */*"
  })
  ...
  @HTTP(
    method = "GET",
    path = "/apis/flows.knative.dev/v1/sequences"
  )
  @Headers({ 
    "Accept: */*"
  })
