...
package com.marcnuri.yakc.api.samplesoperatoropenshiftio.v1;
...
public interface SamplesOperatorOpenshiftIoV1Api extends Api {
  ...
  @HTTP(
    method = "DELETE",
    path = "/apis/samples.operator.openshift.io/v1/configs/{name}",
    hasBody = true
  )
  @Headers({ 
    "Content-Type: application/json",
  ...
  @HTTP(
    method = "GET",
    path = "/apis/samples.operator.openshift.io/v1/configs/{name}/status"
  )
  @Headers({ 
    "Accept: */*"
  })
