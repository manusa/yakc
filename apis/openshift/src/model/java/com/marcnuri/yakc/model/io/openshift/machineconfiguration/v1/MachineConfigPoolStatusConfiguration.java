...
@Data
@ToString
public class MachineConfigPoolStatusConfiguration implements Model {
   ...
   */
  @JsonProperty("source")
  @Singular(value = "addToSource", ignoreNullCollections = true)
  private List<MachineConfigPoolSpecConfigurationSource> source;
