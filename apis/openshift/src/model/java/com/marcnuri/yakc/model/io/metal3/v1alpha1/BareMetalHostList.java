...
package com.marcnuri.yakc.model.io.metal3.v1alpha1;
...
@Data
@ToString
public class BareMetalHostList implements Model, ListModel<BareMetalHost> {
  ...
  private List<BareMetalHost> items;
