...
package com.marcnuri.yakc.model.io.openshift.machine.v1beta1;
...
@Data
@ToString
public class MachineHealthCheckList implements Model, ListModel<MachineHealthCheck> {
  ...
  private List<MachineHealthCheck> items;
