...
package com.marcnuri.yakc.model.io.openshift.operator.network.v1;
...
@Data
@ToString
public class OperatorPKIList implements Model, ListModel<OperatorPKI> {
  ...
  private List<OperatorPKI> items;
