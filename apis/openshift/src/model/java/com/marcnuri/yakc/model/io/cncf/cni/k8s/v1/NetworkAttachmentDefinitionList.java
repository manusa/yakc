...
package com.marcnuri.yakc.model.io.cncf.cni.k8s.v1;
...
@Data
@ToString
public class NetworkAttachmentDefinitionList implements Model, ListModel<NetworkAttachmentDefinition> {
  ...
  private List<NetworkAttachmentDefinition> items;
