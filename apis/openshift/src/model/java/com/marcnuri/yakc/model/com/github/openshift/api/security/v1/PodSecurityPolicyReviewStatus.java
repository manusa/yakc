...
@Data
@ToString
public class PodSecurityPolicyReviewStatus implements Model {
  ...
  @Singular(value = "addToAllowedServiceAccounts", ignoreNullCollections = true)
  private List<ServiceAccountPodSecurityPolicyReviewStatus> allowedServiceAccounts;
