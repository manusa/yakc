...
@Data
@ToString
public class NetworkSpecDefaultNetwork implements Model {


  @JsonProperty("kuryrConfig")
  private NetworkSpecDefaultNetworkKuryrConfig kuryrConfig;

  @JsonProperty("openshiftSDNConfig")
  private NetworkSpecDefaultNetworkOpenshiftSDNConfig openshiftSDNConfig;

  @JsonProperty("ovnKubernetesConfig")
  private NetworkSpecDefaultNetworkOvnKubernetesConfig ovnKubernetesConfig;
