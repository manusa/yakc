...
package com.marcnuri.yakc.model.io.openshift.autoscaling.v1beta1;
...
@Data
@ToString
public class MachineAutoscalerList implements Model, ListModel<MachineAutoscaler> {
  ...
  private List<MachineAutoscaler> items;
