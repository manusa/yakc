...
@Data
@ToString
public class OAuthSpecBasicAuth implements Model {
  ...
  private OAuthSpecBasicAuthTlsClientCert tlsClientCert;

  @JsonProperty("tlsClientKey")
  private OAuthSpecBasicAuthTlsClientKey tlsClientKey;
