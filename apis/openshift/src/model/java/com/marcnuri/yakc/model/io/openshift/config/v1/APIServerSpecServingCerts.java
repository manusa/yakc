...
@Data
@ToString
public class APIServerSpecServingCerts implements Model {
  ...
  @Singular(value = "addToNamedCertificates", ignoreNullCollections = true)
  private List<APIServerSpecServingCertsNamedCertificates> namedCertificates;
