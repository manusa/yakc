...
package com.marcnuri.yakc.model.io.openshift.autoscaling.v1;
...
@Data
@ToString
public class ClusterAutoscalerList implements Model, ListModel<ClusterAutoscaler> {
  ...
  private List<ClusterAutoscaler> items;
