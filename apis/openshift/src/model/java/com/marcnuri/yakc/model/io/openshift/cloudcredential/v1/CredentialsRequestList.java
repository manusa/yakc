...
package com.marcnuri.yakc.model.io.openshift.cloudcredential.v1;
...
@Data
@ToString
public class CredentialsRequestList implements Model, ListModel<CredentialsRequest> {
  ...
  private List<CredentialsRequest> items;
