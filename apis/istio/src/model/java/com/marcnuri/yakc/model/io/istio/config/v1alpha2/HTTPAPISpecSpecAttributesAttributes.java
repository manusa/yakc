...
@Data
@ToString
public class HTTPAPISpecSpecAttributesAttributes implements Model {
  ...
  private Number int64Value;

  @JsonProperty("stringMapValue")
  private HTTPAPISpecSpecAttributesStringMapValue stringMapValue;
