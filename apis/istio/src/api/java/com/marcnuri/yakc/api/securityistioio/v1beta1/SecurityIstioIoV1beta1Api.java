...
public interface SecurityIstioIoV1beta1Api extends Api {
  ...
  KubernetesCall<Status> deleteCollectionNamespacedAuthorizationPolicy(
  ...
  KubernetesCall<Status> deleteNamespacedAuthorizationPolicy(
  ...
  KubernetesCall<Status> deleteCollectionNamespacedPeerAuthentication(
    @Path("namespace") String namespace);
  ...
  KubernetesCall<Status> deleteNamespacedPeerAuthentication(
    @Path("name") String name,
    @Path("namespace") String namespace, 
    @Body DeleteOptions body);
  ...
  KubernetesCall<Status> deleteCollectionNamespacedRequestAuthentication(
    @Path("namespace") String namespace);
  ...
  KubernetesCall<Status> deleteNamespacedRequestAuthentication(
    @Path("name") String name,
    @Path("namespace") String namespace, 
    @Body DeleteOptions body);
