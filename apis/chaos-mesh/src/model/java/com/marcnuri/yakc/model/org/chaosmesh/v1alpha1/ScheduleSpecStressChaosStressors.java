...
@Data
@ToString
public class ScheduleSpecStressChaosStressors implements Model {


  @JsonProperty("cpu")
  private ScheduleSpecStressChaosStressorsCpu cpu;

  @JsonProperty("memory")
  private ScheduleSpecStressChaosStressorsMemory memory;
